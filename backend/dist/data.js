...
exports.addBlog = exports.addWork = exports.addAbout = void 0;
...
exports.addAbout = {
    ...
    misc: {
        ...
        introdescription: 'My name is Klara. I like to create websites and solve problems.',
        description: [
...
exports.addWork = [
    {
        ...
        description: 'This is the first project I did at IT-Högskolan only a few weeks into my studies. Using only HTML and CSS, I created a website for a bar to implement the different types of elements and styling that I had learnt so far',
    ...
    },
    {
        ...
        shortdescription: 'Using Vue.js and VITE to display data fetched with axios',
        description: "To get started with Vue.js and VITE, I made this website during a two week project. The context was to fetch information from an API and to use a 'Single Page Application' to render the website. Another requirement was to use dynamic routerlinks",
...
exports.addBlog = [
    {
        ...
        date: (0, moment_1.default)('2023-03-23'),
        content: [
    ...
    {
        title: 'Typescript',
        date: (0, moment_1.default)('2023-03-20'),
        content: [
    ...
    },
    {
        ...
        date: (0, moment_1.default)('2023-02-15'),
        content: [
